...
{
    #### change your id
    const CLIENT_ID = '2006300272';
    const CLIENT_SECRET = '330f781d3e91247ce622e834d08fe6f4';
    const REDIRECT_URL = 'http://localhost/center/callblack.php';
    ...
    function token($code, $state)
    {
        ...
        // Check if $_SESSION['state'] is set
    ...
    function sendCURL($url, $header, $type, $data = NULL)
    {
        $request = curl_init();
