<!doctype html>
  ...
  <body>
        ...
        <div class="container bg-light">
          <header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
            <a href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-dark text-decoration-none">
              ...
              <span class="fs-4">ศูนย์กลางเครื่องสำอาง</span>
            </a>
    ...
    <div class=" container-fluid px-5 row flex-lg-row-reverse align-items-center g-5 py-5">
      ...
      <div class="col-lg-6">
        <h1 class="display-5 fw-bold text-body-emphasis lh-1 mb-3">Care For Your Skin, Care For Your Beauty</h1>
        <br>
        <p class="lead">ยินดีต้อนรับทุกท่านเข้าสู่หน้าเพจของเรา
      ...
      <div class="container px-4 " id="featured-7">
        <h2 class="pb-2 border-bottom text-center">Top 10 cosmetics</h2>
        <div class="row g-4 py-5 row-cols-1 row-cols-lg-4">
          <div class="feature col">
            <div class=" container-fluid feature-icon d-inline-flex align-items-center justify-content-center  fs-2 mb-3">
              <img src="img/lo1.png" alt="" width="100" height="140">
            </div>
            <h3 class="fs-3 text-body-emphasis text-center">L’Oréal Paris UV Defender Invisible Fluid SPF50+</h3>
            </a>
          </div>

          <div class="feature col">
            <div class=" container-fluid feature-icon d-inline-flex align-items-center justify-content-center  fs-2 mb-3">
              <img src="img/dior1.png" alt="" width="100" height="140">
            </div>
            <h3 class="fs-3 text-body-emphasis text-center">DIOR HACKSTAGF ROSY GLOW</h3>
            </a>
          </div>

          <div class="feature col">
            <div class=" container-fluid feature-icon d-inline-flex align-items-center justify-content-center  fs-2 mb-3">
              <img src="img/cere1.png" alt="" width="100" height="140">
            </div>
            <h3 class="fs-3 text-body-emphasis text-center">Cerave Cerave Moisturising Lotion</h3>
            </a>
          </div>

          <div class="feature col">
            <div class=" container-fluid feature-icon d-inline-flex align-items-center justify-content-center  fs-2 mb-3">
              <img src="img/chamiss.png" alt="" width="100" height="140">
            </div>
            <h3 class="fs-3 text-body-emphasis text-center">Charmiss Airy Glow Everyday Cushion</h3>
            </a>
          </div>
        </div>
      </div>
    ...
    <div class="row g-5 py-6 row-cols-2 row-cols-lg-6 pt-5">
      ...
      <div class="container px-4 py-5" id="featured-100">
      ...
      <div class="container">
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
          ...
          <div class="col-10 col-sm-8 col-lg-6 pt-5">
            <img src="img/22.png" alt="" width="600" height="500">
          </div>
          <div class="col-lg-6 pt-5">
            <h1 class="display-5 fw-bold text-body-emphasis lh-1 mb-3">SKIN CARE OF CENTER BEAUTY</h1>
            <br>
            <p class="lead">Let our website be a part of helping you decide to use the right cosmetic products for your facial skin type.</p>
            <div class="d-grid gap-2 d-md-flex justify-content-md-start">
            </div>
          </div>
        </div>
    ...
    <div class="row featurette">
      <div class="col-md-7 pt-5">
        <h2 class="featurette-heading text-sm-end fw-normal font-cuba lh-1">SKINTIFIC 5X Ceramide Barrier Repair
          Moisturize Gel <span class="text-body-secondary"></span></h2>
        <p class="text-sm-end font-Prompt">เหมาะสำหรับผิวแห้ง
          Ceramide 5 ชนิดเพื่อบำรุงและรักษาเกราะป้องกันผิว กรดไฮยาลูโรนิกฟื้นฟูและกักเก็บความชุ่มชื้นให้กับผิว
          รักษาความยืดหยุ่นของผิวและปรับผิวให้เรียบเนียน</p>
        <a href="#" class="card-link ">Card link</a>
      </div>
      <div class="col-md-5">
        <img src="img/skinti1.png" class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto"
          width="300" height="300" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: 500x500"
          preserveAspectRatio="xMidYMid slice" focusable="false">
        <title>Placeholder</title>
        <rect width="100%" height="100%" fill="var(--bs-secondary-bg)"></rect></svg>
      </div>
    </div>
    ...
    <div class="row featurette">
      <div class="col-md-7 order-md-2 pt-5">
        <h2 class="featurette-heading fw-normal font-cuba lh-1">Neutrogena Hydro Boost Water Gel <span
            class="text-body-secondary">See for yourself.</span></h2>
        <p class="text-start font-Prompt">เหมาะสำหรับทุกสภาพผิวโดยเฉพาะผิวขาดน้ำ
          เนื้อเจลบางเบามีแอนตี้ออกซิแดนท์ โอลีฟ เอ็กแทร็กซ์ช่วยฟื้นบำรุงปราการผิว
          เติมและล๊อคความชุ่มชื้น เผยผิวอิ่มน้ำ</p>
        <a href="#" class="card-link ">Card link</a>
      </div>
      <div class="col-md-5 order-md-1">
        <img src="img/Neutrogena.jpg" class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto"
          width="300" height="300" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: 500x500"
          preserveAspectRatio="xMidYMid slice" focusable="false">
        <title>Placeholder</title>
        <rect width="100%" height="100%" fill="var(--bs-secondary-bg)"></rect></svg>
    ...
    <div class="row featurette">
      <div class="col-md-7 pt-5">
        <h2 class="featurette-heading text-sm-end fw-normal font-cuba lh-1">Cetaphil Moisturising Cream<span
            class="text-body-secondary">Checkmate.</span></h2>
        <p class="text-sm-end font-Prompt">เหมาะสำหรับผิวบอบบางแพ้ง่ายและผิวแห้งถึงแห้งมาก
          ครีมบำรุงเนื้อครีมเข้มข้น ฟื้นคืนผิวนุ่มชุ่มชื้น และคงความชุ่มชื้นได้นานถึง 48 ชั่วโมง</p>
        <a href="#" class="card-link ">Card link</a>
      </div>
      ...
      <!-- <div class="card" style="width: 300">
                <div class="card-body">             -->
      <div class="col-md-5">
        <img src="img/ceta.png" class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto"
          width="300" height="300" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: 500x500"
          preserveAspectRatio="xMidYMid slice" focusable="false">
        <title>Placeholder</title>
        <rect width="100%" height="100%" fill="var(--bs-secondary-bg)"></rect></svg>
