      ...
      <div class="card-body">
        ...
        <form method="post" action="login_user.php">
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="m_name" name="username" placeholder="Enter your username" required>
          </div>
          <div class="mb-3">
            <label for="password" class="form-label">Password</label>
            <input type="password" class="form-control" id="m_password" name="password" placeholder="Enter your password" required>
          </div>
