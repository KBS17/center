                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Product:
                                <?= htmlspecialchars($row['pro_name']) ?></h6>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="d-flex">
                                    <div class="col-10 col-sm-8 col-lg-6 pt-5 text-center">
                                        ...
                                        <img src="../uploads/products/<?= htmlspecialchars($row['picture_name']) ?>"
                                            alt="<?= htmlspecialchars($row['pro_name']) ?>" width="400" height="400"
                                        ...
                                        <div class="rounded p-2 mt-5 d-flex g-3 justify-content-center">
                                            ...
                                            <button class="border border-0 bg-transparent">
                                                <img src="../uploads/products/<?= htmlspecialchars($row1['picture_name']) ?>"
                                                    class="rounded float-start" width="70" alt="Thumbnail">
                                            </button>
                                            <?php }
                                            } else {
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="proname" id="ProductName"
                                                ...
                                                value="<?= htmlspecialchars($row['pro_name']) ?>">
                                        </div>
                                        <!-- Product price -->
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" name="proprice" id="ProductPrice"
                                                ...
                                                value="<?= htmlspecialchars($row['pro_price']) ?>">
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="type_id" aria-label="ProductType">
                                                <option selected disabled><?= htmlspecialchars($row['type_name']) ?>
                                                </option>
                                                <?php while ($typeProducts = $result3->fetch_assoc()): ?>
                                                <option value=<?= $typeProducts['id'] ?>>
                                                    <?= $typeProducts['type_name'] ?></option>
                                                <?php endwhile; ?>
                                            </select>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="categories_id"
                                                aria-label="ProductCategories">
                                                <option selected disabled>
                                                    <?= htmlspecialchars($row['categories_name']) ?></option>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="brand_id" aria-label="ProductBrands">
                                                <option selected disabled><?= htmlspecialchars($row['brand_name']) ?>
                                                </option>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" name="description" id="ProductDescription"
                                                rows="5"><?= htmlspecialchars($row['description']) ?></textarea>
                                        </div>

                                        <!-- Main Product Picture Upload -->
                                        <div class="mb-3">
                                            <label for="showimages" class="form-label">Main Product Picture</label>
                                            <input type="file" class="form-control" id="showimages" name="showimages"
                                                accept="image/*">
                                        </div>
